...
//											
//						//�㉺�̉e
//						Shader s = new LinearGradient(0, 0, 0, (60*scale), Color.TRANSPARENT, Color.TRANSPARENT, Shader.TileMode.CLAMP);
//						paint.setShader(s);
...
//	}
	...
	private void drawLens(View view, Canvas canvas){
		...
		if(mLensBitmap == null && view.getWidth() > 0 && view.getHeight() > 0){
			...
			c.drawLine(0,mLensBitmap.getHeight(),mLensBitmap.getWidth(), mLensBitmap.getHeight(), paint);
			paint.setColor(Color.argb(110, 195, 205, 225));
			paint.setStyle(Style.FILL);
			c.drawRect(0,1,mLensBitmap.getWidth(), mLensBitmap.getHeight(), paint);
			c.drawRect(0,1 + mLensBitmap.getHeight()/2,mLensBitmap.getWidth(), mLensBitmap.getHeight(), paint);
